...
def write_summary(writer, index, similarity_loss=0, continuity_loss=0, total_loss=0):
    """
...
def write_epoch_summary(writer, index, similarity_loss=0, continuity_loss=0, total_loss=0):
    """
    Method to write summary to the tensorboard.
    index: global_index for the visualisation
    Losses: all losses used as metric
